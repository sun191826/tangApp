    ...
    e.prototype = {
        ...
        refresh: function() {
            ...
            this.wrapperWidth = this.wrapper.clientWidth,
                ...
                this.scrollerWidth = s.round(this.scroller.offsetWidth * this.scale),
                this.scrollerHeight = s.round(this.scroller.offsetHeight * this.scale),
        ...
        _translate: function(t, i) {
            if (this.options.useTransform ? this.scrollerStyle[h.style.transform] = "translate(" + t + "px," + i + "px) scale(" + this.scale + ") " + this.translateZ : (t = s.round(t),
                i = s.round(i),
        ...
        _wheelZoom: function(t) {
            ...
            "deltaX"in t)
                i = -t.deltaY / s.abs(t.deltaY);
            else if ("wheelDeltaX"in t)
                i = t.wheelDeltaY / s.abs(t.wheelDeltaY);
            else if ("wheelDelta"in t)
                i = t.wheelDelta / s.abs(t.wheelDelta);
            else {
                if (!("detail"in t))
                    return;
